...
export function AGTable() {
  ...
  const [columnDefs, setColumnDefs] = useState<ColDef[]>([
    ...
    {field: "Cantidad", filter: "agNumberColumnFilter"},
    {field: "Precio", filter: "agNumberColumnFilter"},
    {field: "Descripción", filter: "agTextColumnFilter"},
    {field: "UltimoCambio", filter: "agDateColumnFilter"}
  ]);
